...
public class MyMaskView extends View {
    ...
    public static final int MASK_TYPE_NONE_RECTANGLE = 31; //长方形
    public static final int MASK_TYPE_NONE_SQUARE = 41; //正方形
    public static final int MASK_TYPE_ID_CARD_FRONT = 1;
    public static final int MASK_TYPE_ID_CARD_BACK = 2;
    public static final int MASK_TYPE_ID_CARD_FRONT_MANUAL = 3;
    public static final int MASK_TYPE_ID_CARD_BACK_MANUAL = 4;
    ...
    @IntDef({MASK_TYPE_NONE, MASK_TYPE_ID_CARD_FRONT, MASK_TYPE_ID_CARD_BACK, MASK_TYPE_BANK_CARD,
            MASK_TYPE_PASSPORT,MASK_TYPE_ID_CARD_FRONT_MANUAL,MASK_TYPE_ID_CARD_BACK_MANUAL,MASK_TYPE_NONE_SQUARE,MASK_TYPE_NONE_RECTANGLE})
    @interface MaskType {
    ...
    public void setMaskType(@MaskType int maskType) {
        ...
        switch (maskType) {
            ...
            case MASK_TYPE_PASSPORT:
                ...
                break;
            case MASK_TYPE_NONE_RECTANGLE: //长方形
            case MASK_TYPE_NONE_SQUARE: //正方形
            case MASK_TYPE_ID_CARD_FRONT_MANUAL: // 身份证手动正面
            case MASK_TYPE_ID_CARD_BACK_MANUAL: //身份证手动反面
